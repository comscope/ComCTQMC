...
namespace upd {
    ...
    void setup_updates(jsx::value const& jParams, data::Data<Value>& data, state::State<Value> const& state, mch::MarkovChain<Value>& markovChain, int const stream) {
        ...
        expansion::setup_updates<partition::Worm, Mode>(jParams, data, state, markovChain, stream);
        
        
        if(jParams.is(green::Worm::name())) {
            
            expansion::setup_updates<green::Worm, Mode>(jParams, data, state, markovChain, stream);
        ...
        if(jParams.is(green_impr::Worm::name())) {
            ...
            expansion::setup_updates<green_impr::Worm, Mode>(jParams, data, state, markovChain, stream);
        ...
        if(jParams.is(green_imprsum::Worm::name())) {
            ...
            expansion::setup_updates<green_imprsum::Worm, Mode>(jParams, data, state, markovChain, stream);
        ...
        if(jParams.is(vertex::Worm::name())) {
            ...
            expansion::setup_updates<vertex::Worm, Mode>(jParams, data, state, markovChain, stream);
        ...
        if(jParams.is(vertex_impr::Worm::name())) {
            ...
            expansion::setup_updates<vertex_impr::Worm, Mode>(jParams, data, state, markovChain, stream);
        ...
        if(jParams.is(vertex_imprsum::Worm::name())) {
            ...
            expansion::setup_updates<vertex_imprsum::Worm, Mode>(jParams, data, state, markovChain, stream);
        ...
        if(jParams.is(susc_pp::Worm::name())) {
            ...
            expansion::setup_updates<susc_pp::Worm, Mode>(jParams, data, state, markovChain, stream);
        ...
        if(jParams.is(hedin_ph::Worm::name())) {
            ...
            expansion::setup_updates<hedin_ph::Worm, Mode>(jParams, data, state, markovChain, stream);
        ...
        if(jParams.is(hedin_ph_impr::Worm::name())) {
            ...
            expansion::setup_updates<hedin_ph_impr::Worm, Mode>(jParams, data, state, markovChain, stream);
        ...
        if(jParams.is(hedin_ph_imprsum::Worm::name())) {
            ...
            expansion::setup_updates<hedin_ph_imprsum::Worm, Mode>(jParams, data, state, markovChain, stream);
        ...
        if(jParams.is(hedin_pp::Worm::name())) {
            ...
            expansion::setup_updates<hedin_pp::Worm, Mode>(jParams, data, state, markovChain, stream);
        ...
        if(jParams.is(hedin_pp_impr::Worm::name())) {
            ...
            expansion::setup_updates<hedin_pp_impr::Worm, Mode>(jParams, data, state, markovChain, stream);
        ...
        if(jParams.is(hedin_pp_imprsum::Worm::name())) {
            ...
            expansion::setup_updates<hedin_pp_imprsum::Worm, Mode>(jParams, data, state, markovChain, stream);
    ...
    template void setup_updates<imp::Host, double>(jsx::value const& jParams, data::Data<double>& data, state::State<double> const& state, mch::MarkovChain<double>& markovChain, int const stream);
    
    template void setup_updates<imp::Host, ut::complex>(jsx::value const& jParams, data::Data<ut::complex>& data, state::State<ut::complex> const& state, mch::MarkovChain<ut::complex>& markovChain, int const stream);
    
#ifdef MAKE_GPU_ENABLED
    template void setup_updates<imp::Device, double>(jsx::value const& jParams, data::Data<double>& data, state::State<double> const& state, mch::MarkovChain<double>& markovChain, int const stream);
    
    template void setup_updates<imp::Device, ut::complex>(jsx::value const& jParams, data::Data<ut::complex>& data, state::State<ut::complex> const& state, mch::MarkovChain<ut::complex>& markovChain, int const stream);
#endif
