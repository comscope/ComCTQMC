...
namespace ga {
    ...
    template void find_blocks(Tensor<double> const& hloc, BlockStates& blockStates);
    template void find_blocks(Tensor<std::complex<double>> const& hloc, BlockStates& blockStates);
    ...
    template jsx::value diagonalise<double>(jsx::value& jHamiltonian);
    template jsx::value diagonalise<std::complex<double>>(jsx::value& jHamiltonian);
    
    template<typename Value>
    void transform(jsx::value const& jTransformation, jsx::value& jOperator)
    {
    ...
    template void transform<double>(jsx::value const& jTransformation, jsx::value& jOperator);
    template void transform<std::complex<double>>(jsx::value const& jTransformation, jsx::value& jOperator);
    
    
    template<typename Value>
    jsx::value get_annihilation_operators(int N, BlockStates const& blockStates)
    {
    ...
    template jsx::value get_annihilation_operators<double>(int N, BlockStates const& blockStates);
    template jsx::value get_annihilation_operators<std::complex<double>>(int N, BlockStates const& blockStates);
    ...
    template<typename Value>
    jsx::value construct_hloc(jsx::value jTensors, bool b64)
    {
    ...
    template jsx::value construct_hloc<double>(jsx::value jTensors, bool b64);
    template jsx::value construct_hloc<std::complex<double>>(jsx::value jTensors, bool b64);
    ...
    template jsx::value read_hloc<double>(std::string const name);
    template jsx::value read_hloc<std::complex<double>>(std::string const name);
    ...
    template jsx::value construct_annihilation_operators<double>(jsx::value const& jHloc);
    template jsx::value construct_annihilation_operators<std::complex<double>>(jsx::value const& jHloc);
    
    template<typename Value>
    jsx::value construct_observable(jsx::value const& jHloc, jsx::value const& jTensors, bool const throw_error)
    {
    ...
    template jsx::value construct_observable<double>(jsx::value const& jHloc, jsx::value const& jTensors, bool const throw_error);
    template jsx::value construct_observable<std::complex<double>>(jsx::value const& jHloc, jsx::value const& jTensors, bool const throw_error);
    ...
    template jsx::value construct_occupation_states<double>(jsx::value const& jHloc);
    template jsx::value construct_occupation_states<std::complex<double>>(jsx::value const& jHloc);
