...
namespace linalg {
    ...
    template jsx::value conj<double>(jsx::value const& jOp);
    template jsx::value conj<std::complex<double>>(jsx::value const& jOp);
    ...
    template jsx::value diag_to_operator<double>(jsx::value const& jDiag);
    template jsx::value diag_to_operator<std::complex<double>>(jsx::value const& jDiag);
    ...
    template void mult<double>(char transA, char transB, double alpha, jsx::value const& jA, jsx::value const& jB, double beta, jsx::value& jC);
    template void mult<std::complex<double>>(char transA, char transB, double alpha, jsx::value const& jA, jsx::value const& jB, double beta, jsx::value& jC);
    ...
    template double trace<double>(jsx::value const& jA, jsx::value const& jB);
    template std::complex<double> trace<std::complex<double>>(jsx::value const& jA, jsx::value const& jB);
