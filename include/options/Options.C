...
namespace opt {
    ...
    template jsx::value transform(Basis<double> const& basis, Interaction const& interaction);
    template jsx::value transform(Basis<std::complex<double>> const& basis, Interaction const& interaction);
    ...
    template jsx::value truncate(io::Vector<double> const& interaction, double const truncate);
    template jsx::value truncate(io::Vector<std::complex<double>> const& interaction, double const truncate);
    ...
    template void complete_hloc<double>(jsx::value& jParams);
    template void complete_hloc<std::complex<double>>(jsx::value& jParams);
    ...
    template void complete_qn<double>(jsx::value const& jParams, jsx::value& jqn);
    template void complete_qn<std::complex<double>>(jsx::value const& jParams, jsx::value& jqn);
    ...
    template jsx::value transform(Observable const& tensor, Transformation<double> const& transformation, bool ising);
    template jsx::value transform(Observable const& tensor, Transformation<std::complex<double>> const& transformation, bool ising);
    ...
    template jsx::value read_observable<double>(jsx::value const& jObservable, int const N, bool ising);
