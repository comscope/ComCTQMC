        ...
        namespace func {
            ...
            namespace green {
                ...
                jsx::value non_impr_est_evalsim(jsx::value jParams, jsx::value const& jWorm, jsx::value const& jMeasurements, jsx::value const& jPartition, jsx::value const& jObservables){
                    ...
                    std::tie(hyb, hybMoments) =  evalsim::partition::func::get_hybridisation<Value>(jParams);
                    ...
                    std::vector<io::cmat> self =  evalsim::partition::func::get_self_dyson<Value>(jParams,green,hyb);
                ...
                std::vector<io::Matrix<Value>> compute_green_moments(jsx::value const& jParams, std::vector<io::Matrix<Value>> const& hybMoments, jsx::value const& jPartition, jsx::value const& jScalar){
                    double const beta = jParams("beta").real64();
                    jsx::value const& jHybMatrix = jParams("hybridisation")("matrix");
                    jsx::value jDensityMatrix =  evalsim::partition::meas::read_density_matrix<Value>(jParams, jPartition("density matrix"));
                    ...
                    if(jParams.is("dyn"))
                    {
                        ...
                        for(int I = 0; I < jq.size(); ++I)
                        {
                            ...
                            jDensityMatrixDyn(I) =  evalsim::partition::meas::read_density_matrix<Value>(jParams, jPartition("density matrix dyn")(I));
                        }
