...
namespace evalsim {
    ...
    namespace partition {
        ...
        template jsx::value get_hamiltonian<double>(jsx::value const& jParams);
        template jsx::value get_hamiltonian<ut::complex>(jsx::value const& jParams);
        ...
        template jsx::value get_effective_hamiltonian<double>(jsx::value const& jParams);
        template jsx::value get_effective_hamiltonian<ut::complex>(jsx::value const& jParams);
