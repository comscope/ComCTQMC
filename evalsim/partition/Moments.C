...
namespace evalsim {
    ...
    namespace partition {
        ...
        template std::vector<io::Matrix<double>> get_green_moments<double>(jsx::value const& jParams, std::vector<io::Matrix<double>> const& hybMoments, jsx::value const& jMeasurements, jsx::value const& jScalar);
        template std::vector<io::Matrix<ut::complex>> get_green_moments<ut::complex>(jsx::value const& jParams, std::vector<io::Matrix<ut::complex>> const& hybMoments, jsx::value const& jMeasurements, jsx::value const& jScalar);
        ...
        template std::vector<io::Matrix<double>> get_self_moments<double>(jsx::value const& jParams, std::vector<io::Matrix<double>> const& hybMoments, std::vector<io::Matrix<double>> const& greenMoments);
        template std::vector<io::Matrix<ut::complex>> get_self_moments<ut::complex>(jsx::value const& jParams, std::vector<io::Matrix<ut::complex>> const& hybMoments, std::vector<io::Matrix<ut::complex>> const& greenMoments);
