...
namespace evalsim {
    ...
    namespace be {
        ...
        Bessel::Bessel(std::size_t const N, std::size_t const M) : data_(N, std::vector<double>(M)) {
        ...
        std::vector<double> Bessel::bessel_forward(std::size_t const n_high, std::size_t const m) {
        ...
        std::vector<double> Bessel::bessel_backward(std::size_t const n_low, std::size_t const n_high, std::size_t const m, double const val_before_low) {
            double const omega = (2.*m + 1.)*M_PI/2.;
        ...
        std::vector<double> Bessel::bessel(std::size_t const n, std::size_t const m) {
            double const omega = (2.*m + 1.)*M_PI/2.;
