    ...
    namespace partition {
        ...
        namespace meas {
            ...
            namespace impl {
                ...
                template std::pair<io::cvec, io::cvec> read_matsubara_basis(io::Vector<double> const& data, jsx::value const& jParams, jsx::value const& jPartition, int hybSize);
                template std::pair<io::cvec, io::cvec> read_matsubara_basis(io::Vector<ut::complex> const& data, jsx::value const& jParams, jsx::value const& jPartition, int hybSize);
                ...
                template std::pair<io::cvec, io::cvec> read_legendre_basis(io::Vector<double> const& data, jsx::value const& jParams, jsx::value const& jPartition, int hybSize);
                template std::pair<io::cvec, io::cvec> read_legendre_basis(io::Vector<ut::complex> const& data, jsx::value const& jParams, jsx::value const& jPartition, int hybSize);
                ...
                template std::pair<io::cvec, io::cvec> read_function<double>(jsx::value const& jFunction, jsx::value const& jParams, jsx::value const& jPartition, int hybSize);
                template std::pair<io::cvec, io::cvec> read_function<ut::complex>(jsx::value const& jFunction, jsx::value const& jParams, jsx::value const& jPartition, int hybSize);
                ...
                template std::pair<std::vector<io::cmat>, std::vector<io::cmat>> read_functions<double>(jsx::value const& jFunctions, jsx::value const& jParams, jsx::value const& jPartition, jsx::value const& jHybMatrix, int hybSize);
                template std::pair<std::vector<io::cmat>, std::vector<io::cmat>> read_functions<ut::complex>(jsx::value const& jFunctions, jsx::value const& jParams, jsx::value const& jPartition, jsx::value const& jHybMatrix, int hybSize);
            ...
            template std::vector<io::cmat> read_functions<double>(jsx::value const& jFunctions, jsx::value const& jParams, jsx::value const& jPartition, int hybSize);
            template std::vector<io::cmat> read_functions<ut::complex>(jsx::value const& jFunctions, jsx::value const& jParams, jsx::value const& jPartition, int hybSize);
            ...
            template std::pair<std::vector<io::cmat>, std::vector<io::cmat>> read_conj_functions<double>(jsx::value const& jFunctions, jsx::value const& jFunctionsConj, jsx::value const& jParams, jsx::value const& jPartition, int hybSize);
            template std::pair<std::vector<io::cmat>, std::vector<io::cmat>> read_conj_functions<ut::complex>(jsx::value const& jFunctions, jsx::value const& jFunctionsConj, jsx::value const& jParams, jsx::value const& jPartition, int hybSize);
