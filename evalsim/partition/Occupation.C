...
namespace evalsim {
    ...
    namespace partition {
        ...
        template jsx::value get_occupation<double>(jsx::value const& jParams, jsx::value const& jMeasurements, io::Matrix<double>& occupation, io::Matrix<double>& correlation);
        template jsx::value get_occupation<ut::complex>(jsx::value const& jParams, jsx::value const& jMeasurements, io::Matrix<ut::complex>& occupation, io::Matrix<ut::complex>& correlation);
