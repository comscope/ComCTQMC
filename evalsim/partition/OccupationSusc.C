...
namespace evalsim {
    ...
    namespace partition {
        ...
        template io::rmat get_occupation_susc_moments<double>(jsx::value const& jParams, jsx::value const& jPartition, jsx::value const& jMeasurements, jsx::value& jObservables);
        template io::rmat get_occupation_susc_moments<ut::complex>(jsx::value const& jParams, jsx::value const& jPartition, jsx::value const& jMeasurements, jsx::value& jObservables);
        ...
        template jsx::value get_occupation_susc_bulla<double>(jsx::value const& jParams, jsx::value const& jPartition, jsx::value const& jMeasurements, io::rmat const& moments, io::Matrix<double> const& occupation, io::Matrix<double> const& correlation, jsx::value& jObservables);
        template jsx::value get_occupation_susc_bulla<ut::complex>(jsx::value const& jParams, jsx::value const& jPartition, jsx::value const& jMeasurements, io::rmat const& moments, io::Matrix<ut::complex> const& occupation, io::Matrix<ut::complex> const& correlation, jsx::value& jObservables);
        ...
        template jsx::value get_occupation_susc_direct<double>(jsx::value const& jParams, jsx::value const& jPartition, jsx::value const& jMeasurements, io::rmat const& moments, io::Matrix<double> const& occupation, io::Matrix<double> const& correlation, jsx::value& jObservables);
        template jsx::value get_occupation_susc_direct<ut::complex>(jsx::value const& jParams, jsx::value const& jPartition, jsx::value const& jMeasurements, io::rmat const& moments, io::Matrix<ut::complex> const& occupation, io::Matrix<ut::complex> const& correlation, jsx::value& jObservables);
